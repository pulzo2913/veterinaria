...
<title>Consultas| CARE PET</title>
    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active" style="background-image: url(../Veterinaria/images/slider/bg4.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Bienvenidos por favor antes de hacer una consulta debes registrarte primero.</h1>
                                    <h2 class="animation animated-item-2">Para registrarte haz click en el boton de abajo</h2>
                                    <a class="btn-slide animation animated-item-3" href="Registro.php">R E G I S T R A T E</a>
                                </div>
                            </div>

                            <div class="col-sm-6 hidden-xs animation animated-item-4">
                                <div class="slider-img">
                                    <img src="../Veterinaria/images/slider/img4.jpg" class="img-responsive">
                                </div>
                            </div>
